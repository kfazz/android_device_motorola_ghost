...
#define SENSORHUB_ALGO_MODALITY         MSP_IDX_MODALITY
#define SENSORHUB_ALGO_ORIENTATION      MSP_IDX_ORIENTATION
#define SENSORHUB_ALGO_STOWED           MSP_IDX_STOWED
#define SENSORHUB_ALGO_ACCUM_MODALITY   MSP_IDX_ACCUM_MODALITY
#define SENSORHUB_ALGO_ACCUM_MVMT       MSP_IDX_ACCUM_MVMT
